...
elseif ($_GET["security_code"] != "uhejbvgr01gl7v7yuyzr" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_50ky";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=uhejbvgr01gl7v7yuyzr" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ftp.t10world.com"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="itl@t10world.com"></td></tr>
