	...
	<div class="content">
		...
		<div class="core">
          ...
          {// The form is submitted
            ...
            $validator->addValidation("mletter","req","Please upload your motivation letter");
            $validator->addValidation("cv","req","Please upload your CV");
            ...
            { 
              ...
              $path_of_mletter = $upload_folder . $name_of_uploaded_file;
              $tmp_path = $_FILES["mletter"]["tmp_name"];
               
              if(is_uploaded_file($tmp_path))
              {
                if(!copy($tmp_path,$path_of_mletter))
                {
              ...
              //copy the temp. uploaded file to uploads folder
              $path_of_cv = $upload_folder . $name_of_uploaded_file;
              $tmp_path = $_FILES["cv"]["tmp_name"];
               
              if(is_uploaded_file($tmp_path))
              {
                if(!copy($tmp_path,$path_of_cv))
                {
                  $errors .= '\n error while copying the uploaded file';
                }
              }
          ...
          <div class="form_container">
            ...
            <form id="myForm" action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
              ...
              <p>
                <label><strong>Motivation Letter <br/>(only word or pdf): <span style="color:red">*</span></strong>
                </label><input name="mletter" type="file" />
                <br class="clearAll" /><br />
              </p>
              
              <p>
                <label><strong>Curriculum Vitae <br/>(only word or pdf): <span style="color:red">*</span></strong>
                </label><input name="cv" type="file" />
                <br class="clearAll" /><br />
              </p>
